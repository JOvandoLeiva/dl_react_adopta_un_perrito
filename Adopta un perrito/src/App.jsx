...
function App() {
  ...
  return (
    ...
    <div className='cartas img'>
      ...
      <Tarjeta url = './src/assets/img/perrito_03.jpg' name ='Nunu' description='Pequeño y cariñoso perrito color canela. Busca un regazo cálido y un hogar amoroso.' fondo='Primary' texto ='Cruzado'/>
